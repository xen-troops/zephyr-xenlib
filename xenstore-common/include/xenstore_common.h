 ...
 */
__maybe_unused inline static bool xenstore_is_abs_path(const char *path)
{
	if (!path) {
		return false;
	}
 ...
 */
__maybe_unused inline static bool xenstore_is_root_path(const char *path)
{
 ...
 */
__maybe_unused inline static bool xenstore_check_indexes(XENSTORE_RING_IDX cons, XENSTORE_RING_IDX prod)
{
 ...
 */
__maybe_unused inline static size_t xenstore_get_input_offset(XENSTORE_RING_IDX cons, XENSTORE_RING_IDX prod,
					      size_t *len)
{
 ...
 * @return Offset chunk starts.
 */
__maybe_unused inline static size_t get_output_offset(XENSTORE_RING_IDX cons, XENSTORE_RING_IDX prod,
					       size_t *len)
{
